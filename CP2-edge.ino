...
byte N[8] = { B10001, B10001, B11001, B10101, B10011, B10001, B10001, B10001 };
byte T[8] = { B00000, B11111, B00100, B00100, B00100, B00100, B00100, B00100 };
byte T2[8] = { B00000, B11111, B00100, B00100, B00100, B00100, B00100, B00100 };
byte S[8] = { B01110, B11001, B10000, B11000, B01110, B00011, B10011, B01110};
byte ponto[8] = { B00000, B00000, B00000, B00000, B00000, B00000, B11000, B11000 };
...
void logo(){
  ...
  exibirCaracterePersonalizado(N,6,0,0);
  
  delay(100);
  
  //Chama a função para Criar um caractere personalizado temporário
  exibirCaracterePersonalizado(T,6,1,1);
  ...
  //Chama a função para Criar um caractere personalizado temporário
  exibirCaracterePersonalizado(S,8,0,3);
  
  delay(100);
  
  //Chama a função para Criar um caractere personalizado temporário
  exibirCaracterePersonalizado(T2,8,1,4);
